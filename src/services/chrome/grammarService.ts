/**
 * Singleton service for managing grammar analysis session
...
type StatusListener = (status: GrammarStatusItem) => void;

class GrammarService {
  private static instance: GrammarService;
  ...
  private notifyStatusChange(status: GrammarStatusItem) {
        ...
        initialPrompts: [
          {
            role: 'system',
            content:
              'You are a helpful grammar teacher who provides clear, educational explanations.',
          },
        ],
        temperature: defaults.defaultTemperature,
        topK: defaults.defaultTopK,
        expectedInputs: [{ type: 'text', languages: ['en', validSourceLanguage] }],
        expectedOutputs: [{ type: 'text', languages: [validTargetLanguage] }],
      };
...
export const grammarService = GrammarService.getInstance();
