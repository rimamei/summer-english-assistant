...
declare interface SummarizerMonitor extends EventTarget {
     ...
     */
    addEventListener: (type: 'downloadprogress', listener: (event: SummarizerDownloadProgressEvent) => void) => void
}
...
declare interface SummarizerInstance {
     ...
     * @throws {UnknownError} Other unknown errors
     */
    summarizeStreaming: (text: string, options?: SummarizerOperationOptions) => ReadableStream<string>;
}
